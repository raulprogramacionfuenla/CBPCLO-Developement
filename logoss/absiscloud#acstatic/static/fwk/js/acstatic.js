...
function initDatePickers() {
	var datePikerJSPath = "/static/fwk/components/bootstrap-datepiker-eternicode/1.0.0/js/";
...
function click2callInit(){
	if($('span[data-role="c2c"]').length > 0){
		...
		$.getJSON("/absiscloud/"+applicationName+"/fwk/c2c", function( data ) {
...
function absisCloudRenderize() {
	...
	$('.help-block').parent().parent(".control-group").addClass('error');
	$('input[disabled="disabled"]').parent().parent(".control-group").addClass('disabled');
	$('input[readonly="readonly"]').parent().parent(".control-group").addClass('disabled');
...
function initToogleBoxes() {
	...
	$("div.toggle-box .toggle-box-boton-contraer").click(function(){
		$(this).parent("div.toggle-box").collapse('toggle');
	});
	
	$("div.toggle-box .toggle-box-boton-contraer")
		.parent("div.toggle-box")
			.on('hidden', function () {
				$(this).removeClass("expandido");
				$(this).addClass("contraido");
      });
	
	$("div.toggle-box .toggle-box-boton-expandir").click(function(){
		$(this).parent("div.toggle-box")
					.removeClass("contraido")
					.addClass("expandido");
		$(this).parent("div.toggle-box")
					.collapse('toggle');
		
	});
	$(this).parent("div.toggle-box").addClass('collapse');
	$(this).parent("div.toggle-box.expandido").addClass('in');
	...
	$("div.toggle-box .toggle-box-boton-resumir").click(function(){
		$(this).parent(".toggle-box-content").parent("div.toggle-box").removeClass("completo");
		$(this).closest('.toggle-box-content').children("form").removeClass("row-fluid");
		$(this).closest('.toggle-box-content').children("form.super-expandido").addClass("inline-fields");
		$(this).closest('.toggle-box-content').children("form.super-expandido").removeClass("row-fluid");
	});
	
	$("div.toggle-box .toggle-box-boton-completar").click(function(){
		$(this).parent().parent("div.toggle-box").addClass("completo");
		$(this).closest('.toggle-box-content').children("form").addClass("row-fluid");
		$(this).closest('.toggle-box-content').children("form.super-expandido").removeClass("inline-fields");
		$(this).closest('.toggle-box-content').children("form.super-expandido").removeClass("row-fluid");
	});
	$("div.toggle-box.completo .toggle-box-content form").addClass("row-fluid");
	$("div.toggle-box.completo .toggle-box-content form.super-expandido").removeClass("inline-fields");
	$("div.toggle-box.completo .toggle-box-content form.super-expandido").removeClass("row-fluid");
...
var timePikerJSPath = "/static/fwk/components/bootstrap-timepicker/0.2.3/js/";
...
function initCheckBox() {
	$('div[class=consultas-controls] input[type=checkbox]').each(function () {
        if (this.checked) {
        	$('<span class="add-on"><i class="icono-bullet-check-OK"></i></span>').insertBefore(this);
        } else {
        	$('<span class="add-on"><i class="icono-bullet-check-KO"></i></span>').insertBefore(this);
        }
	});
}
