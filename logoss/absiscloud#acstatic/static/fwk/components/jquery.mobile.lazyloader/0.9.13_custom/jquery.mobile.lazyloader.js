( function( $, undefined ) {
    ...
    $.widget( "mobile.lazyloader", $.mobile.widget, {
        ...
        _bind : function () {
            ...
            $( window ).bind( "scrollstart", $.proxy( this._handleScrollStart, this ) );
            $( window ).bind( "scrollstop", $.proxy( this._handleScrollStop, this ) );
        ...
        _unbind : function () {
            ...
            $( window ).unbind( "scrollstart", this._handleScrollStart );
            $( window ).unbind( "scrollstop", this._handleScrollStop );
